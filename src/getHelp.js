function printUsage() {
   ...
   console.log(
      "    -d, --dest         :  Specify the destination of output image (Any valid path. If file exist, it will be replaced). By default active directory is used as output destination."
   );
   ...
   console.log("    dimpic  photo.jpg  -q  40  -d  ~/Desktop/");
   console.log(
      "    dimpic  pic1.png  pic2.jpg  pic3.jpg  -d  /home/username/Document/"
   );
   console.log(
